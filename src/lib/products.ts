...
type ServiceProductCandidate = Pick<Product, 'brand' | 'name' | 'category'> & Partial<Pick<Product, 'slug'>>;

export function isServiceProduct(product: ServiceProductCandidate): boolean {
