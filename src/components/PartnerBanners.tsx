...
const AUTHORIZED_BRANDS = [
  {
    ...
    text: 'Tehnologie AI EcoMaster și eficiență energetică A+++.',
  ...
  },
  {
    ...
    logoBg: 'bg-gray-50',
    text: 'Sisteme split, VRF și pompe de căldură cu tehnologie Cold Plasma și Wi-Fi integrat.',
    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <div className="mb-10 text-center">
          ...
          <h2 className="section-title mt-2">Branduri de climatizare</h2>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-dark-300">
            Produse originale și service specializat pentru brandurile de mai jos.
          </p>
        </div>
          ...
          {AUTHORIZED_BRANDS.map((brand) => (
            ...
            >
              ...
              <div className="mb-3 flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-green-700">Produse originale</span>
              </div>
        ...
        <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-gray-100 bg-gray-50 px-6 py-4">
          <span className="text-sm font-semibold text-dark-300">Service și pentru:</span>
          {EXTRA_BRANDS.map((b) => (
